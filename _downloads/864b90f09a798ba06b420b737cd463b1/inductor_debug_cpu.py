...
# around `basic usage <https://maskerprc.github.io/tutorials/intermediate/torch_compile_tutorial.html>`_,
...
# `Pytorch Profiler <https://maskerprc.github.io/tutorials/recipes/recipes/profiler_recipe.html>`_ is a good tool to help us.
...
######################################################################
# Following the steps in `Pytorch Profiler <https://maskerprc.github.io/tutorials/recipes/recipes/profiler_recipe.html>`_
