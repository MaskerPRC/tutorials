...
* `NLP From Scratch: Classifying Names with a Character-Level RNN <https://maskerprc.github.io/tutorials/intermediate/char_rnn_classification_tutorial.html>`__
* `NLP From Scratch: Generating Names with a Character-Level RNN <https://maskerprc.github.io/tutorials/intermediate/char_rnn_generation_tutorial.html>`__
* `NLP From Scratch: Translation with a Sequence to Sequence Network and Attention <https://maskerprc.github.io/tutorials/intermediate/seq2seq_translation_tutorial.html>`__
...
# we will use the `Dataset and DataLoader <https://maskerprc.github.io/tutorials/beginner/basics/data_tutorial.html>`__ classes
