...
with high performance requirements. For that:
    ...
    - If you're already familiar with TorchScript, you can jump straight into our
      `Loading a TorchScript Model in C++ <https://maskerprc.github.io/tutorials/advanced/cpp_export.html>`_ tutorial.

    - If you first need a refresher on TorchScript, check out our
      `Intro a TorchScript <https://maskerprc.github.io/tutorials/beginner/Intro_to_TorchScript_tutorial.html>`_ tutorial.
"""
