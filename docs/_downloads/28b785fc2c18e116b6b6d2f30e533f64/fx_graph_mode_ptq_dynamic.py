...
We have a separate tutorial for `FX Graph Mode Post Training Static Quantization <https://maskerprc.github.io/tutorials/prototype/fx_graph_mode_ptq_static.html>`_,
...
We will copy the code from `Dynamic Quantization on an LSTM Word Language Model <https://maskerprc.github.io/tutorials/advanced/dynamic_quantization_tutorial.html>`_
