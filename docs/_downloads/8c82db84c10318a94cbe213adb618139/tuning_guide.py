...
###############################################################################
# Refer to
# `Introduction to torch.compile <https://maskerprc.github.io/tutorials/intermediate/torch_compile_tutorial.html>`_
...
# `Channels Last Memory Format Tutorial <https://maskerprc.github.io/tutorials/intermediate/memory_format_tutorial.html>`_.
# The tutorial includes a section on
# `converting existing models <https://maskerprc.github.io/tutorials/intermediate/memory_format_tutorial.html#converting-existing-models>`_.
...
#     `tutorial <https://maskerprc.github.io/tutorials/recipes/recipes/amp_recipe.html>`_
#
#
